...
Connect your Metamask wallet by clicking on the Connect Wallet button in the top right corner of the application.
Once your wallet is connected, you can view the ongoing campaigns on the home page.
To contribute to a campaign, click on the campaign card and enter the amount you wish to contribute. Confirm the transaction in your Metamask wallet to complete the contribution.
To start a crowdfunding project, click on the Add Project button in the navigation bar. Fill in the required information, such as project details, fundraising goal, and deadline for the campaign.
Click on the Create Project button to deploy your campaign on the blockchain. You can view your ongoing campaigns on the My Campaigns page.
Once your campaign reaches its fundraising goal before the deadline, you can withdraw the funds raised by clicking on the Withdraw Funds button on the campaign card.
